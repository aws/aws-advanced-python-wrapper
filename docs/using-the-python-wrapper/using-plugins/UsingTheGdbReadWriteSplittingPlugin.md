...
| `gdb_rw_restrict_writer_to_home_region`| Boolean |                                                                     No                                                                     | If set to `True`, prevents following or connecting to a writer host outside the defined home region. An exception will be raised when a connection to a writer outside the home region is requested.                                                                                                                                                                                               | `True`                                                                                                                           |
| `gdb_rw_restrict_reader_to_home_region`| Boolean |                                                                     No                                                                     | If set to `True`, prevents connecting to a reader host outside the defined home region. If no reader hosts in the home region are available, an exception will be raised.                                                                                                                                                                                                                          | `True`                                                                                                                           |
