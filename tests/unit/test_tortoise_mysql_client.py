...
from aws_advanced_python_wrapper.tortoise_orm.backends.mysql.client import (
...
class TestAwsMySQLClient:
    ...
    async def test_create_connection_success(self):
        ...
        with patch('aws_advanced_python_wrapper.tortoise_orm.backends.mysql.client.logger'):
            await client.create_connection(with_db=True)
