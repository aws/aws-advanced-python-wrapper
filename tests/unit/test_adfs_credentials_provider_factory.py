...
def test_get_saml_assertion(mock_request, mock_plugin_service):
    ...
    sign_in_page_html = "./unit/resources/federated_auth/adfs-sign-in-page.html"
    adfs_saml_html = "./unit/resources/federated_auth/adfs-saml.html"
    saml_assertion_txt = "./unit/resources/federated_auth/saml-assertion.txt"
