...
public class TestEnvironmentRequest {
  ...
  @JsonProperty("targetPythonVersion")
  private TargetPythonVersion targetPythonVersion;
  ...
  public TestEnvironmentRequest(
    ...
    this.targetPythonVersion = targetPythonVersion;
  ...
  @JsonIgnore
  public TargetPythonVersion getTargetPythonVersion() {
    return this.targetPythonVersion;
  }
