...
from aws_advanced_python_wrapper.utils.decorators import timeout, timeout_with_new_thread
        ...
        if MySQLDriverDialect._is_mysql_connection(conn):
            ...
            if self.can_execute_query(conn):
                ...
                if not is_releasing_resources:
                    ...
                    # When the wrapper destructor is called
                    # the executor may also be deleted in the same time which could cause a deadlock.
