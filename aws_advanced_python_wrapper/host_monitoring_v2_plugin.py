    ...
    def execute(self, target: object, method_name: str, execute_func: Callable, *args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            monitor_context = self._monitor_service.start_monitoring(
                ...
                WrapperProperties.FAILURE_DETECTION_INTERVAL_MS.get_int(self._properties),
                WrapperProperties.FAILURE_DETECTION_COUNT.get_int(self._properties)
            )
            result = execute_func()
        finally:
