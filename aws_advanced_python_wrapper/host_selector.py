            ...
            if host_weights is not None and len(host_weights) != 0:
                ...
                for pair in host_weight_pairs:
                    ...
                    if match:
                        ...
                        raise AwsWrapperError(Messages.get("RoundRobinHostSelector.RoundRobinInvalidHostWeightPairs"), pair)
            ...
            if host_weights is not None and len(host_weights) != 0:
                ...
                for pair in host_weight_pairs:
                    ...
                    if match:
                        ...
                        raise AwsWrapperError(Messages.get("WeightedRandomHostSelector.WeightedRandomInvalidHostWeightPairs"), pair)
